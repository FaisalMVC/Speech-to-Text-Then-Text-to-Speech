...
# This fuction take the script that have been saved from the speech, then convert it to voice mp3 file. The mp3 file will be run.  
def text_to_speech():
    url = 'https://api.us-south.text-to-speech.watson.cloud.ibm.com/instances/6d844440-27e3-406f-946f-3841c44ded3c'
    apikey = 'aArZ0k5GJ3_311jmMwZezH-FYU5WnZTEnggVx9IPvSsW'
...
def on_message(self, msg):
    ...
    if "results" in data:
        ...
        print(data['results'][0]['alternatives'][0]['transcript'])   # Here is the text , so my work is here  
